...
<body>
    ...
    <footer class="footer">
        <div class="footer__cta" style="background-image: url({{ asset('images/footer_background.png')  }});">
        ...
        <div class="footer__copyright container">
            ...
            <div class="footer__copyright-container">
                <p class="text-center primary-color remove-spacing"> Copyrights &copy; {{ date('Y') }} On Point Marketing 2023. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
